...
// Import Data
var colorData = require('../data/mozilla/color.json');
var colorStyleData = require('../data/mozilla/colorstyle.json');
var imageData = require('../data/mozilla/image.json');
var textData = require('../data/mozilla/text.json');
