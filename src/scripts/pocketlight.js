...
// Import Data
var colorData = require('../data/pocketlight/color.json');
var colorStyleData = require('../data/pocketlight/colorstyle.json');
var imageData = require('../data/pocketlight/image.json');
var textData = require('../data/pocketlight/text.json');
