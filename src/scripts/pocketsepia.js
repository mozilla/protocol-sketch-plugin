...
// Import Data
var colorData = require('../data/pocketsepia/color.json');
var colorStyleData = require('../data/pocketsepia/colorstyle.json');
var imageData = require('../data/pocketsepia/image.json');
var textData = require('../data/pocketsepia/text.json');
