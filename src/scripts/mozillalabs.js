...
// Import Data
var colorData = require('../data/mozillalabs/color.json');
var colorStyleData = require('../data/mozillalabs/colorstyle.json');
var imageData = require('../data/mozillalabs/image.json');
var textData = require('../data/mozillalabs/text.json');
