...
exports['default'] = function (context) {
  ...
  app.globalAssets().setColors([magenta50, magenta60, magenta70, magenta80, magenta90, purple50, purple60, purple70, purple80, purple90, blue40, blue50, blue50_A30, blue60, blue70, blue80, blue90, teal50, teal60, teal70, teal80, teal90, green50, green60, green70, green80, green90, yellow50, yellow60, yellow70, yellow80, yellow90, red50, red60, red70, red80, red90, orange50, orange60, orange70, orange80, orange90, grey10, grey20, grey30, grey40, grey50, grey60, grey70, grey80, grey90, grey90_A05, grey90_A10, grey90_A20, grey90_A30, grey90_A40, grey90_A50, grey90_A60, grey90_A70, grey90_A80, grey90_A90, ink70, ink80, ink90, white100]);
...
function createColor(color, element, format) {
  ...
  for (var variant in element) {
    if (element.hasOwnProperty(variant)) {
      ...
      try {
        for (var _iterator = (value.opacity || [])[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var alpha = _step.value;

          var out = format.formatter(color, variant, value.hex, alpha);
          if (out) {
            rv.push(out);
          }
        }
